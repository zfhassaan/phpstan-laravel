...
$user->accounts()->forceCreateMany([['foo' => 'bar']]);
$user->accounts()->forceCreateManyQuietly([['foo' => 'bar']]);
...
$user->accounts()->forceCreateMany([['name' => 'foo']]);
$user->accounts()->forceCreateManyQuietly([['name' => 'foo']]);
