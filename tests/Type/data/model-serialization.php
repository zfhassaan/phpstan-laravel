...
{
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}', $model->attributesToArray());
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}', $model->toArray());
...
function boundaries(
    ...
    assertType('array{email_verified_at?: string|null, id?: int, ...<string, mixed>}', $hidden->attributesToArray());
    ...
    assertType('array<string, mixed>', $override->toArray());
    assertType('array{custom: true}', $toArrayOverride->toArray());
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}', $toArrayOverride->attributesToArray());
    assertType('array{year: int}|null', $dateOverride->attributesToArray()['email_verified_at']);
    assertType('array<string, mixed>', $base->toArray());

    $partial = SerializationModel::query()->select('id')->firstOrFail();
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}', $partial->toArray());
...
function additionalBoundaries(
    ...
    SerializationModel|null $nullable,
): void {
    ...
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}', $intersection->attributesToArray());
    assertType('bool|string', $union->attributesToArray()['name']);
    assertType('array{email_verified_at?: string|null, id?: int, name?: string, label?: string, ...<string, mixed>}|null', $nullable?->attributesToArray());
}
