...
use CalebDW\PhpstanLaravel\Rules\Queue\JobWithModelPropertyDeclaresSerializesModelsRule;
...
class JobWithModelPropertyDeclaresSerializesModelsRuleTest extends RuleTestCase
{
    ...
    {
        $this->fix(__DIR__ . '/data/serializes-models-fix.php', __DIR__ . '/data/serializes-models-fix-expected.php');
    }
